...
class TvsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        if (App::environment()!=='production') {
          DB::table('tvs')->delete();
          $tvs = [
              ['id' => 1, 'name' => 'Crear Gameboy con Sass, HTML y JavaScript', 'description' => 'En este tutorial exploraremos Sass y crearemos un Gameboy como ejemplo.', 'array_tags' => '', 'url' => 'https://www.youtube.com/embed/v=ldkgsUMOct8', 'author_id' => 7, 'image' => 'images/tv/crear-gameboy-con-sass-html-y-javascript-tv1.jpg'],
